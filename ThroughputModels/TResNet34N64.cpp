...
int main(int argc, char *argv[]) {
    ...
    rkeys_layer4.push_back(convert_keys);
...
/********************************************************************************************************************************************/;
    ...
    for (int idx = 0; idx < 1; idx++) {
        ...
        fcData = fc_layer_block(fheController, annBatchController, "layer_fc", fcData, batchSizes[1], channels[4], channels[5], fcRotIndex);
        ...
        auto predictions = fheController.read_batch_inferencedLabel(fcData, batchSizes[1], channels[5], outFile);
