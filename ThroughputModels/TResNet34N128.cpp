...
int main(int argc, char *argv[]) {
    ...
    vector<int> batchSizes = {16, 64, 128};
    int pipeVal = 4;
    int pipVal2 = 2;
...
/********************************************************************************************************************************************/;
    ...
    for (int idx = 0; idx < 1; idx++) {
        ...
        fcData = fc_layer_block(fheController, annBatchController, "layer_fc", fcData, batchSizes[2], channels[4], channels[5], fcRotIndex);
        ...
        auto predictions = fheController.read_batch_inferencedLabel(fcData, batchSizes[2], channels[5], outFile);
